...
public class PerlinNoise implements Noise {
    ...
    /**
     * Set all of the properties of the localNoise generator in one swoop
     *
     * @param seed
    ...
    private double getValue(double x, double y) {
        ...
        // localNoise values
        double n01 = localNoise(Xint - 1, Yint - 1);
        double n02 = localNoise(Xint + 1, Yint - 1);
        double n03 = localNoise(Xint - 1, Yint + 1);
        double n04 = localNoise(Xint + 1, Yint + 1);
        double n05 = localNoise(Xint - 1, Yint);
        double n06 = localNoise(Xint + 1, Yint);
        double n07 = localNoise(Xint, Yint - 1);
        double n08 = localNoise(Xint, Yint + 1);
        double n09 = localNoise(Xint, Yint);

        double n12 = localNoise(Xint + 2, Yint - 1);
        double n14 = localNoise(Xint + 2, Yint + 1);
        double n16 = localNoise(Xint + 2, Yint);

        double n23 = localNoise(Xint - 1, Yint + 2);
        double n24 = localNoise(Xint + 1, Yint + 2);
        double n28 = localNoise(Xint, Yint + 2);

        double n34 = localNoise(Xint + 2, Yint + 2);

        // find the localNoise values of the four corners
    ...
    private double localNoise(int x, int y) {
        int n = x + y * 57;
        n = (n << 13) ^ n;
